...
class TestBaseModelFunctionality:
    ...
    def test_base_model_has_big_auto_field_id(self, db_fixture):
        ...
        obj = ConcreteBaseModel.objects.create(name="Test Object")
    ...
    def test_base_model_id_is_auto_increment(self, db_fixture):
        ...
        obj1 = ConcreteBaseModel.objects.create(name="Object 1")
        obj2 = ConcreteBaseModel.objects.create(name="Object 2")
        
        assert obj2.id > obj1.id

    def test_base_model_id_not_editable(self, db_fixture):
        """Test ID field is not editable."""
        model_field = ConcreteBaseModel._meta.get_field('id')
    ...
    def test_base_model_string_representation(self, db_fixture):
        ...
        str_repr = str(obj)
        assert "ConcreteBaseModel" in str_repr
        assert f"#{obj.id}" in str_repr

    def test_base_model_default_ordering(self, db_fixture):
        """Test default ordering is by -id (descending)."""
        obj1 = ConcreteBaseModel.objects.create(name="First")
        obj2 = ConcreteBaseModel.objects.create(name="Second")
        obj3 = ConcreteBaseModel.objects.create(name="Third")
        
        all_objects = list(ConcreteBaseModel.objects.all())
...
class TestTimeStampedModelFunctionality:
    ...
    def test_created_at_auto_set_on_create(self, db_fixture):
        ...
        obj = ConcreteTimeStampedModel.objects.create(title="Test Title")
    ...
    def test_updated_at_changes_on_save(self, db_fixture):
        ...
        obj = ConcreteTimeStampedModel.objects.create(title="Original Title")
    ...
    def test_created_at_does_not_change_on_update(self, db_fixture):
        ...
        obj = ConcreteTimeStampedModel.objects.create(title="Original")
    ...
    def test_timestamped_model_default_ordering(self, db_fixture):
        ...
        obj1 = ConcreteTimeStampedModel.objects.create(title="First")
        obj2 = ConcreteTimeStampedModel.objects.create(title="Second")
        obj3 = ConcreteTimeStampedModel.objects.create(title="Third")
        
        all_objects = list(ConcreteTimeStampedModel.objects.all())
    ...
    def test_created_at_has_db_index(self, db_fixture):
        ...
        field = ConcreteTimeStampedModel._meta.get_field('created_at')
        assert field.db_index is True

    def test_updated_at_has_db_index(self, db_fixture):
        """Test updated_at field has database index."""
        field = ConcreteTimeStampedModel._meta.get_field('updated_at')
        assert field.db_index is True
...
class TestSoftDeleteManagerFunctionality:
    ...
    def test_manager_filters_deleted_objects_by_default(self, db_fixture):
        ...
        obj1 = ConcreteSoftDeleteModel.objects.create(description="Active")
        obj2 = ConcreteSoftDeleteModel.objects.create(description="To be deleted")
        
        obj2.delete()  # Soft delete
        
        active_objects = ConcreteSoftDeleteModel.objects.all()
    ...
    def test_all_with_deleted_returns_all_objects(self, db_fixture):
        ...
        obj1 = ConcreteSoftDeleteModel.objects.create(description="Active")
        obj2 = ConcreteSoftDeleteModel.objects.create(description="Deleted")
        
        obj2.delete()
        
        all_objects = ConcreteSoftDeleteModel.objects.all_with_deleted()
    ...
    def test_deleted_only_returns_soft_deleted_objects(self, db_fixture):
        ...
        obj1 = ConcreteSoftDeleteModel.objects.create(description="Active")
        obj2 = ConcreteSoftDeleteModel.objects.create(description="Deleted 1")
        obj3 = ConcreteSoftDeleteModel.objects.create(description="Deleted 2")
        
        obj2.delete()
        obj3.delete()
        
        deleted_objects = ConcreteSoftDeleteModel.objects.deleted_only()
    ...
    def test_all_objects_manager_returns_everything(self, db_fixture):
        ...
        ConcreteSoftDeleteModel.objects.create(description="Active")
        obj2 = ConcreteSoftDeleteModel.objects.create(description="Deleted")

        obj2.delete()

        all_records = ConcreteSoftDeleteModel.all_objects.all()
...
class TestSoftDeleteFunctionality:
    ...
    def test_soft_delete_sets_deleted_at_timestamp(self, db_fixture):
        ...
        obj = ConcreteSoftDeleteModel.objects.create(description="Test")
    ...
    def test_soft_delete_does_not_remove_from_database(self, db_fixture):
        ...
        all_records = ConcreteSoftDeleteModel.all_objects.filter(id=obj_id)
...
class TestSoftDeleteableModelFunctionality:
    ...
    def test_soft_deleteable_has_all_features(self, db_fixture):
        ...
        obj = ConcreteSoftDeleteableModel.objects.create(content="Test Content")
    ...
    def test_soft_deleteable_timestamps_update_correctly(self, db_fixture):
        ...
        obj = ConcreteSoftDeleteableModel.objects.create(content="Original")
    ...
    def test_soft_deleteable_soft_delete_workflow(self, db_fixture):
        ...
        obj = ConcreteSoftDeleteableModel.objects.create(content="Test")
        ...
        assert ConcreteSoftDeleteableModel.objects.count() == 0
        
        # Still in all_objects
        assert ConcreteSoftDeleteableModel.all_objects.count() == 1
        
        # Restore
        obj.restore()
        assert obj.is_deleted is False
        assert ConcreteSoftDeleteableModel.objects.count() == 1

    def test_soft_deleteable_ordering(self, db_fixture):
        """Test SoftDeleteable uses created_at for ordering."""
        obj1 = ConcreteSoftDeleteableModel.objects.create(content="First")
        obj2 = ConcreteSoftDeleteableModel.objects.create(content="Second")
        obj3 = ConcreteSoftDeleteableModel.objects.create(content="Third")
        
        all_objects = list(ConcreteSoftDeleteableModel.objects.all())
...
class TestRealWorldDatabaseScenarios:
    ...
    def test_user_account_soft_deletion_scenario(self, db_fixture):
        ...
        """
        # Create user account
        user = ConcreteSoftDeleteableModel.objects.create(content="user@example.com")
        
        # User requests account deletion
        user.delete()
        
        # User should not appear in active queries
        active_users = ConcreteSoftDeleteableModel.objects.all()
        assert user not in active_users
        
        # Admin can still see deleted accounts
        all_users = ConcreteSoftDeleteableModel.all_objects.all()
        assert user in all_users
        
        # User changes mind and restores account within 30 days
        user.restore()
        assert user in ConcreteSoftDeleteableModel.objects.all()
    ...
    def test_bulk_soft_delete_and_restore(self, db_fixture):
        ...
        objects = [
            ConcreteSoftDeleteableModel.objects.create(content=f"Item {i}")
            for i in range(5)
        ]
        ...
        # Check counts
        assert ConcreteSoftDeleteableModel.objects.count() == 2
        assert ConcreteSoftDeleteableModel.objects.deleted_only().count() == 3
        
        # Restore all deleted
        for obj in ConcreteSoftDeleteableModel.objects.deleted_only():
            obj.restore()
        
        assert ConcreteSoftDeleteableModel.objects.count() == 5

    def test_audit_trail_with_timestamps(self, db_fixture):
        """
        Scenario: Track when records were created, updated, and deleted.
        """
        obj = ConcreteSoftDeleteableModel.objects.create(content="Important Document")
        ...
        assert deleted_time >= updated_time  # Delete happens after or at same time as last update
    ...
    def test_filtering_by_date_range(self, db_fixture):
        ...
        obj1 = ConcreteSoftDeleteableModel.objects.create(content="Old record")
        # Manually set created_at to simulate old record
        ConcreteSoftDeleteableModel.all_objects.filter(id=obj1.id).update(
            created_at=now - timedelta(days=10)
        )
        
        obj2 = ConcreteSoftDeleteableModel.objects.create(content="Recent record")
        
        # Find records created in last 7 days
        recent_cutoff = now - timedelta(days=7)
        recent_records = ConcreteSoftDeleteableModel.objects.filter(
    ...
    def test_permanent_deletion_after_retention_period(self, db_fixture):
        ...
        old_obj = ConcreteSoftDeleteableModel.objects.create(content="Old deleted record")
        recent_obj = ConcreteSoftDeleteableModel.objects.create(content="Recent deleted record")
        ...
        ConcreteSoftDeleteableModel.all_objects.filter(id=old_obj.id).update(
            deleted_at=old_deletion_time
        )
        
        # Find records deleted more than 30 days ago
        retention_cutoff = timezone.now() - timedelta(days=30)
        old_deleted = ConcreteSoftDeleteableModel.all_objects.filter(
        ...
        assert not ConcreteSoftDeleteableModel.all_objects.filter(id=old_obj.id).exists()
        
        # Recent record should still exist
        assert ConcreteSoftDeleteableModel.all_objects.filter(id=recent_obj.id).exists()
    ...
    def test_cascade_soft_delete_simulation(self, db_fixture):
        ...
        """
        parent = ConcreteSoftDeleteableModel.objects.create(content="Parent Record")
        child1 = ConcreteSoftDeleteableModel.objects.create(content=f"Child of {parent.id}")
        child2 = ConcreteSoftDeleteableModel.objects.create(content=f"Child of {parent.id}")
        ...
        assert ConcreteSoftDeleteableModel.all_objects.count() == 3
